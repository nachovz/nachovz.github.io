...
const manifest = deserializeManifest({
  ...
  routes: [
    {
      file: "",
      links: [],
      scripts: [{ type: "external", value: "/hoisted.kPPQrZRG.js" }],
      styles: [{ type: "external", src: "/index.KUocwji0.css" }],
      routeData: {
        route: "/",
        type: "page",
        pattern: "^\\/$",
  ...
  site: "https://theignaciocordoba.com",
  base: "/",
  trailingSlash: "ignore",
  compressHTML: true,
  componentMetadata: [
    [
      "/home/nachovz/dev/astro/personal-website/src/pages/index.astro",
  ...
  entryModules: {
    ...
    "/src/pages/index.astro": "chunks/pages/index_5uJ_idW2.mjs",
    "\u0000@astrojs-manifest": "manifest_k9YE9AAh.mjs",
    "/astro/hoisted.js?q=0": "hoisted.kPPQrZRG.js",
